...
Uangku menggunakan arsitektur **feature-first Flutter architecture** dengan pemisahan yang jelas antara:
...
Uangku adalah aplikasi **offline-first personal money management**, sehingga arsitektur harus memprioritaskan data lokal, performa, stabilitas, dan maintainability.
...
Target utama Uangku adalah Android.
...
Uangku uses a feature-first Flutter architecture with local-first data storage, reusable premium UI components, centralized design tokens, and clear separation between app, core, data, features, and shared layers.
