...
This file is the primary guide for AI coding agents working on Uangku.

## Project Overview

Uangku is an offline-first Android personal finance tracker built with Flutter. The app helps users manage income, expenses, transfers, wallets, budgets, and backups locally on their device. It also includes on-device receipt/screenshot scanning (OCR) to help pre-fill transaction details.
...
- Keep Uangku offline-first.
- Keep data local by default.
- Keep user-facing app name as `Uangku`.
- Technical slug and package names may remain `uangku`.
...
- Internet access should remain tied to user-triggered actions such as external links or sharing exports.
