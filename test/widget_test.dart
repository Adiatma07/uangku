...
import 'package:uangku/app/app.dart';
import 'package:uangku/app/providers/app_providers.dart';
import 'package:uangku/app/theme/app_theme.dart';
import 'package:uangku/data/local/database/app_database.dart';
import 'package:uangku/data/repositories/app_models.dart';
import 'package:uangku/data/repositories/security_repository.dart';
import 'package:uangku/features/dashboard/dashboard_page.dart';
import 'package:uangku/shared/widgets/premium_bottom_nav.dart';
...
void main() {
  ...
  testWidgets('Uangku app shell renders', (WidgetTester tester) async {
    await tester.pumpWidget(_withOverrides(const UangkuApp()));
    await tester.pump();
