...
class BackupRepository {
  ...
  Future<String> exportJson() async {
    ...
    final name =
        'uangku-backup-${DateTime.now().millisecondsSinceEpoch}.json';
    final file = _xFile(
      name: name,
    ...
    await SharePlus.instance.share(
      ShareParams(
        files: [file],
        text: 'Cadangan Uangku. Simpan file ini di tempat yang aman.',
      ),
    );
    return name;
  }
  ...
  Future<String> exportCsv() async {
    ...
    final name =
        'uangku-transaksi-${DateTime.now().millisecondsSinceEpoch}.csv';
    final file = _xFile(
      name: name,
    ...
    await SharePlus.instance.share(
      ShareParams(files: [file], text: 'CSV transaksi Uangku'),
    );
    return name;
  }
