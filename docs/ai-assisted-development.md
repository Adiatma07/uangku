...
Uangku may use AI-assisted tooling for development, review, documentation, and maintenance. AI assistance is treated as a workflow aid, not as a replacement for human review.
...
AI must not claim that Uangku is more secure than it is. App lock is local protection, not full database encryption. Backup files contain financial data and should be stored safely.
