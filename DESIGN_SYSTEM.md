# Uangku Design System

## 1. Design Direction

Uangku menggunakan pendekatan visual **iOS-inspired premium mobile interface** yang diadaptasi untuk Android.
...
Namun Uangku **bukan clone iOS**, bukan Apple Wallet clone, dan bukan aplikasi yang memaksakan pola iPhone mentah ke Android.
...
Ketika pengguna membuka Uangku, kesan yang harus muncul:
...
UI Uangku harus terasa lega. Jangan padat seperti aplikasi admin dashboard.
...
Uangku harus memakai custom reusable components. Jangan terlalu bergantung pada widget default tanpa styling.
...
```txt
Belum ada transaksi
Tambahkan transaksi pertama agar Uangku bisa mulai membaca pola keuanganmu.
```
...
```txt
Tambahkan transaksi pertama agar Uangku bisa membaca pola keuanganmu.
...
Uangku should feel like a calm, premium, iOS-inspired personal finance app adapted for Android. It must prioritize fast input, readable financial information, soft visual hierarchy, elegant surfaces, smooth motion, and offline-first practicality.
